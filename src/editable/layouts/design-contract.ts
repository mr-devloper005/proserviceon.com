...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#151827',
  '--slot4-panel-bg': '#fff4e9',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4f566b',
  '--slot4-soft-muted-text': '#667085',
  '--slot4-accent': '#ff6b2b',
  '--slot4-accent-fill': '#ff6b2b',
  '--slot4-accent-soft': '#e9f8ef',
  '--slot4-dark-bg': '#2d275b',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eef1f5',
  '--slot4-cream': '#fff7ef',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#eef7ff',
  '--slot4-gray': '#f4f6f8',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f7f8fb 44%, #ffffff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-3xl font-extrabold leading-[1.1] tracking-tight sm:text-4xl lg:text-[2.85rem]',
